...
$query = "INSERT INTO games(title, company, total_chapters, finished_chapters, finished) VALUES (?, ?, ?, ?, ?)";
...
$stmt->execute([$_POST['title'], $_POST['company'], $_POST['total_chapters'], $finished_chapters, $finished]);
